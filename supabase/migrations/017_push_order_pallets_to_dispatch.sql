-- RetiFlux™ — Push order pallets to dispatch (child pallets)
-- Migration 017: When order has order_pallets, move ONLY released child pallets (never legacy)
-- Run after 014, 015. Updates push_order_to_dispatch.

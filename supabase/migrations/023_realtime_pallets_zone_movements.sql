-- Realtime for public ticket view (app/ticket-view.html) and any client using
-- postgres_changes with filters on pallet_id. Filtered subscriptions need FULL replica identity.
